...
const AppProvider = ({ children }) => {
  const [token, setToken] = useState(
    localStorage.getItem("token") ||
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY2Y2I5NzE3NGRmODRhNzc3NGZlYzE2ZSIsImVtYWlsIjoiYmlzaG9zZWRyYTBAZ21haWwuY29tIiwiaWF0IjoxNzI0NjE4NTUwLCJleHAiOjE3NTYxNzYxNTB9.TecomUnB_aAhs7DEk0y9crhm-v5BBZaFTV3LgwBJejk"
  );
